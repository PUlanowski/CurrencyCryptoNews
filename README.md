...
1. Non relational database structure was defined as one stage table with all records and two smaller analytics tables. </br>
Primary key used here is composite of id/author/date created.

![image](screenshots/cassie_dd.png)

2. For relational database I've chosen star schema with splitting one table per currency (and with intermediate staging tables for pre-processing). 

![image](screenshots/pg_dd.png)
